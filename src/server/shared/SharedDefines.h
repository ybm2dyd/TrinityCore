...
SMART_ENUM(SpellPreventionType,
(
    (SPELL_PREVENTION_TYPE_NONE, 0, ("None")),
    (SPELL_PREVENTION_TYPE_SILENCE, 1, ("Silence")),
    (SPELL_PREVENTION_TYPE_PACIFY, 2, ("Pacify"))
));
SMART_ENUM_BOUND(SpellPreventionType, MAX_SPELL_PREVENTION_TYPE);

SMART_ENUM((SpellInterruptFlags, uint32),
(
    (SPELL_INTERRUPT_FLAG_MOVEMENT, 0x01, ("Cancel on move")),
    (SPELL_INTERRUPT_FLAG_PUSH_BACK, 0x02, ("Pushback on damage")),
    (SPELL_INTERRUPT_FLAG_UNK3, 0x04, ("Unk3")),
    (SPELL_INTERRUPT_FLAG_INTERRUPT, 0x08, ("Interruptable")),
    (SPELL_INTERRUPT_FLAG_ABORT_ON_DMG, 0x10, ("Interrupt on damage")),
    (SPELL_INTERRUPT_FLAG_UNK4, 0x20, ("Unk4"))
));

// See SpellAuraInterruptFlags for other values definitions
SMART_ENUM((SpellChannelInterruptFlags, uint32),
(
    (CHANNEL_INTERRUPT_FLAG_INTERRUPT, 0x0008, ("Interruptable")),
    (CHANNEL_FLAG_DELAY, 0x4000, ("Delay on damage"))
));
